...
export type StorageHash =
  StorageHashBase<'b5bedaf442300aeb087be6591eb15c0eeffe8d52567883e751f5203397ea456d'>;
export type ExecutionHash =
  ExecutionHashBase<'355bd382d172b725b2744b758bca97ea474e0acbb64c4adffb07f3c881b1f01e'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly AIRequest: {
      ...
      readonly provider: 'GEMINI' | 'OPENAI' | 'CLAUDE' | 'CUSTOM';
    ...
    readonly ProjectSettings: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly projectId: CodecTypes['pg/text@1']['output'];
      readonly brandName: CodecTypes['pg/text@1']['output'];
      readonly defaultDuration: CodecTypes['pg/int4@1']['output'];
      readonly defaultAspectRatio: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly PublishJob: {
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ProjectSettings: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly projectId: CodecTypes['pg/text@1']['input'];
      readonly brandName: CodecTypes['pg/text@1']['input'];
      readonly defaultDuration: CodecTypes['pg/int4@1']['input'];
      readonly defaultAspectRatio: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly PublishJob: {
...
export namespace Models {
  ...
  export type public_Project = {
    ...
    contentIdeas: public_ContentIdea[];
    owner: public_User;
    settings: public_ProjectSettings | null;
    readonly [RelationKeys]?: 'contentIdeas' | 'owner' | 'settings';
  };
  export type public_ProjectSettings = {
    id: CodecTypes['pg/text@1']['output'];
    projectId: CodecTypes['pg/text@1']['output'];
    brandName: CodecTypes['pg/text@1']['output'];
    defaultDuration: CodecTypes['pg/int4@1']['output'];
    defaultAspectRatio: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
...
export declare const models: {
  public: {
    ...
    ProjectSettings: Models.public_ProjectSettings;
          ...
          readonly table: {
            ...
            readonly aIWorkflow: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'aIWorkflow_contentId_status_idx_9952abf4';
                  readonly prefix: 'aIWorkflow_contentId_status_idx';
                  readonly columns: readonly ['contentId', 'status'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly projectSettings: {
              columns: {
                ...
                readonly defaultAspectRatio: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', '9:16'>;
                  };
                };
                readonly createdAt: {
                  readonly nativeType: 'timestamptz';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'projectSettings';
                    readonly columns: readonly ['projectId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly projectSettings: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ProjectSettings';
    };
    readonly contentIdea: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          ...
          readonly ProjectSettings: {
            ...
            readonly storage: {
              readonly table: 'projectSettings';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly projectId: { readonly column: 'projectId' };
                readonly brandName: { readonly column: 'brandName' };
                readonly defaultDuration: { readonly column: 'defaultDuration' };
                readonly defaultAspectRatio: { readonly column: 'defaultAspectRatio' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          ...
          readonly WorkflowType: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'SCRIPT_GENERATION'; readonly value: 'SCRIPT_GENERATION' },
              { readonly name: 'VIDEO_GENERATION'; readonly value: 'VIDEO_GENERATION' },
              { readonly name: 'AUDIO_GENERATION'; readonly value: 'AUDIO_GENERATION' },
              { readonly name: 'IMAGE_GENERATION'; readonly value: 'IMAGE_GENERATION' },
            ];
          };
        };
      };
